...
// English-only keywords for cultural digest search (no Arabic)
export const DEFAULT_KEYWORDS = [
  // Saudi Arabia culture & Vision 2030
  "Saudi Arabia culture",
  "Saudi Arabia arts",
  "Saudi Arabia museums",
  "Saudi Arabia heritage",
  "Vision 2030 culture",
  "Saudi Arabia film",
  "Saudi Arabia music",
  ...
  "Saudi Arabia theater",
  "Saudi Arabia culinary arts",
  "Saudi Arabia cultural diplomacy",
  "Saudi Arabia soft power",
  "Saudi Arabia entertainment",
  "Saudi Arabia art gallery",
  "Saudi Arabia cultural festival",
  "Saudi Arabia creative industry",
  ...
  "Saudi culture ministry",
  "Saudi MoC",
  "Saudi MOC",
  "Saudi Minister of Culture",
  "Saudi Culture Minister",
  "Saudi Arabia's Culture Minister",
  "Minister of Culture Prince Badr",
  "Saudi Culture Minister Prince Badr",
  ...
  "Saudi Vice Minister of Culture",
  "Vice Minister of Culture Hamed Fayez",
  ...
  "Library Commission",
  "Language Commission",
  "Saudi culture commission",
  "Saudi cultural commission",
...
// Arabic and local outlets to exclude from results
export const EXCLUDED_ARABIC_OUTLETS = [
  "sabq.org",
  "okaz.com.sa",
  "alriyadh.com",
  "ajel.sa",
...
export const defaultConfig: SearchConfig = {
  ...
  excludedTerms: [],
  excludedSources: EXCLUDED_ARABIC_OUTLETS.map((source, index) => ({
    id: `excluded-arabic-${index}`,
    value: source,
  })),
  executiveSummary: "",
